...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_bind', models.BooleanField(default=False, verbose_name='是否被绑定')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('college_id', models.IntegerField(default=-1, verbose_name='所属大学')),
                ('card_number', models.CharField(default='-1', max_length=50, verbose_name='学号或教工号')),
